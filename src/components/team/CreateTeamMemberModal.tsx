          ...
          {createdCredentials ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-dark-border">
                ...
                <div className="p-3.5 rounded-2xl bg-brand-50/50 dark:bg-brand-950/20 border border-brand-200 dark:border-brand-900/40 flex items-start justify-between gap-3">
                  <div>
                    <label htmlFor="create-setup-completed-checkbox" className="text-xs font-bold text-slate-800 dark:text-gray-200 block cursor-pointer">
                      Employee Operations Setup Completed
                    </label>
                    <span className="text-[10px] text-slate-500 dark:text-gray-400 block mt-0.5">
                      Validates shift assignment, department access, and monthly salary for automated attendance tracking and monthly payroll generation.
                    </span>
                  </div>
                  <input
                    id="create-setup-completed-checkbox"
                    type="checkbox"
                    checked={setupCompleted}
                    onChange={(e) => setSetupCompleted(e.target.checked)}
                    className="mt-0.5 w-4 h-4 text-brand-600 rounded-md focus:ring-brand-500 cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-dark-border">
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-gray-400 flex items-center gap-1.5">
                  ...
                  <span>7. Bank Account Details (For Salary Disbursement)</span>
                </h3>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div className="space-y-1">
                    <label htmlFor="create-bank-name" className="block text-xs font-semibold text-slate-700 dark:text-gray-300">
                      Bank Name
                    </label>
                    <input
                      id="create-bank-name"
                  ...
                  <div className="space-y-1">
                    <label htmlFor="create-account-title" className="block text-xs font-semibold text-slate-700 dark:text-gray-300">
              ...
              <div className="space-y-3 pt-2 border-t border-slate-100 dark:border-dark-border">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-gray-400 flex items-center gap-1.5">
                    ...
                    <span>8. Login Credentials <span className="text-rose-500">*</span></span>
                  </h3>
                  <button
                    type="button"
