            ...
            <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-dark-300 border border-slate-200 dark:border-dark-border shadow-xs space-y-4">
              ...
              {(profile.linkedinUrl || profile.facebookUrl || profile.instagramUrl) && (
                <div className="pt-3 border-t border-slate-100 dark:border-dark-border">
                  <span className="text-slate-400 block text-[11px] font-semibold mb-2">Social & Communication Profiles</span>
                  <div className="flex items-center gap-3 flex-wrap">
                    {profile.linkedinUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-50 dark:bg-blue-950/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-900/50 text-xs font-semibold hover:bg-blue-100 transition-colors"
                      >
                    ...
                    {profile.facebookUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/30 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-900/50 text-xs font-semibold hover:bg-indigo-100 transition-colors"
                      >
                    ...
                    {profile.instagramUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-pink-50 dark:bg-pink-950/30 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-900/50 text-xs font-semibold hover:bg-pink-100 transition-colors"
                      >
