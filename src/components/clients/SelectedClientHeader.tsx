...
const PACKAGE_STYLES: Record<string, string> = {
  ...
  Intermediate: 'bg-blue-500/10 text-blue-700 dark:text-blue-300 border-blue-500/20',
  Advanced: 'bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border-emerald-500/20'
};
  ...
  const linkButtons = [
    {
      ...
      colorClass: 'hover:bg-slate-100 hover:text-slate-800 dark:hover:bg-dark-300 dark:hover:text-slate-200 hover:border-slate-300'
    },
    {
