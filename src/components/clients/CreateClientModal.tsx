...
export const CreateClientModal: React.FC<CreateClientModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      ...
      >
        {/* Header */}
        <div className="px-5 sm:px-6 py-4 border-b border-gray-100 dark:border-dark-border flex items-center justify-between bg-gray-50/50 dark:bg-dark-300/30">
          ...
          <button
            ...
            className="p-2 rounded-lg text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-dark-100 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center cursor-pointer"
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-dark-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                <label htmlFor="link-flc-landing-page" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  FLC Landing Page URL
                </label>
                <input
                  id="link-flc-landing-page"
                  type="url"
              ...
              <div>
                <label htmlFor="link-videos" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Videos URL
                </label>
                <input
                  id="link-videos"
              ...
              <div>
                <label htmlFor="link-social-media-management" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Social Media Management URL
                </label>
                <input
                  id="link-social-media-management"
                  data-testid="link-social-media-management"
                  type="url"
              ...
              <div>
                <label htmlFor="link-linkedin-management" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  LinkedIn Management URL
                </label>
                <input
                  id="link-linkedin-management"
                  data-testid="link-linkedin-management"
                  type="url"
              ...
              <div>
                <label htmlFor="link-seo-management" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  SEO Management URL
                </label>
                <input
                  id="link-seo-management"
                  data-testid="link-seo-management"
                  type="url"
              ...
              <div>
                <label htmlFor="link-email-marketing-management" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Email Marketing Management URL
                </label>
                <input
                  id="link-email-marketing-management"
                  data-testid="link-email-marketing-management"
                  type="url"
              ...
              <div>
                <label htmlFor="link-paid-ads-management" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Paid Ads Management URL
                </label>
                <input
                  id="link-paid-ads-management"
                  data-testid="link-paid-ads-management"
                  type="url"
          ...
          {/* Footer Actions */}
          <div className="pt-4 border-t border-gray-100 dark:border-dark-border flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              disabled={isSubmitting}
              className="px-4 py-2.5 rounded-xl border border-gray-200 dark:border-dark-border text-xs font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-dark-100 transition-colors min-h-[44px] flex items-center justify-center cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isSubmitting}
              className="flex items-center justify-center gap-2 px-5 py-2.5 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-brand-500/25 hover:shadow-brand-500/40 transition-all disabled:opacity-50 min-h-[44px] cursor-pointer"
            >
              {isSubmitting ? (
                <>
