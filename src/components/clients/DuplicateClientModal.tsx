        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-dark-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                <label htmlFor="dup-brand-identity" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Brand Identity URL
                </label>
                <input
                  id="dup-brand-identity"
                  type="url"
              ...
              <div>
                <label htmlFor="dup-important-docs" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Important Documents URL
                </label>
                <input
                  id="dup-important-docs"
                  data-testid="dup-important-docs"
                  type="url"
              ...
              <div>
                <label htmlFor="dup-master-business-doc" className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Master Business Document URL
                </label>
                <input
                  id="dup-master-business-doc"
                  data-testid="dup-master-business-doc"
                  type="url"
