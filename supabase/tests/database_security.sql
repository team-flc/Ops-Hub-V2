...
SELECT throws_ok(
    ...
    '42501',
    'permission denied for function fn_employee_check_in',
...
SELECT throws_ok(
    ...
    'P0001',
    'Forbidden: active internal employee profile required.',
...
SELECT throws_ok(
    ...
    'P0001',
    'Employee setup is pending. Management must complete employment, shift, and payroll configuration before attendance can be recorded.',
...
SELECT throws_ok(
    ...
    'P0001',
    'Invalid evidence path: must reside in authenticated employee directory.',
...
SELECT throws_ok(
    ...
    '42501',
    'permission denied for function fn_cron_process_attendance_automation',
